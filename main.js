...
const idInvalidCompanies = (invalidNumbers) => {
  const companies = [];
...
console.log(idInvalidCompanies([invalid1]))
console.log(idInvalidCompanies(batch)); // Find out which companies have mailed out invalid cards
